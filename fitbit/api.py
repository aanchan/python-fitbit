...
class Fitbit(object):
    ...
    def _COLLECTION_RESOURCE(self, resource, date=None, user_id=None,
        ...
        * https://dev.fitbit.com/docs/
        ...
        if not data:
            if list_arg:
                base_url = "{0}/{1}/user/{2}/{resource}/list.json?beforeDate={date}&sort=desc&offset=0&limit=100"
            else:
    ...
    def get_sleep_before_with_url(self, url):
        ...
        is auto-generated by Fitbit using the next field
        within the pagination JSON when a Fitbit list API call is made.
